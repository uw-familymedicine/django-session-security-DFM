...
AA_EXPIRE_AFTER = getattr(settings, 'SESSION_SECURITY_YAR_EXPIRE_AFTER', EXPIRE_AFTER)

WARN_AFTER = getattr(settings, 'SESSION_SECURITY_WARN_AFTER', 540)

AA_WARN_AFTER = getattr(settings, 'SESSION_SECURITY_YAR_WARN_AFTER', WARN_AFTER)
